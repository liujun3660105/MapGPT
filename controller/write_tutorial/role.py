...
from .action import WriteContent, WriteDirectory
...
class TutorialAssistant(Role):
    ...
    async def _handle_directory(self, titles: Dict) -> Message:
        ...
        actions = list()
        content_node_list = find_leaf_nodes(titles.get("directory"))## 获取所有叶子节点,叶子节点需要添加内容
        for leaf_node in content_node_list:
            actions.append(WriteContent(language=self.language,current_section=leaf_node, directory=directory))
